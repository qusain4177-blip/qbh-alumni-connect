...
export default defineMcp({
  name: "qbh-alumni-mcp",
  title: "QBH Alumni Portal",
  version: "0.1.0",
  instructions:
    "Tools for the Qamar E Bani Hashim school alumni network. Look up your own alumni profile, update it, search the alumni directory, and browse events and announcements. All tools act as the signed-in alumnus and respect row-level security.",
