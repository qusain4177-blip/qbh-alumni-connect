...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Tools for the QBHS UMBRELLA school alumni network. Look up your own alumni profile, update it, search the alumni directory, and browse events and announcements. All tools act as the signed-in alumnus and respect row-level security.",
