...
export default defineTool({
  ...
  description: "Search the Qamar E Bani Hashim School Alumni Directory. Filter by name, Matric passing year, or Matric stream. Row-level security limits results to what the signed-in user can see.",
  inputSchema: {
