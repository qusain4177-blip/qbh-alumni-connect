    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden border-b border-border bg-navy">
        <div className="absolute inset-0">
          <img src={heroImg} alt="QBHS UMBRELLA campus building" className="h-full w-full object-cover object-center opacity-30" width={1600} height={1100} />
        ...
        <div className="container relative mx-auto px-4 py-28 lg:px-8 lg:py-36">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-base leading-relaxed text-white/65 lg:text-lg">
              The official alumni network of QBHS UMBRELLA. Find your batch, share what you're working on, and stay in touch.
            </p>
