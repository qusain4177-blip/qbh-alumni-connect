...
const CalendarPlus = createLucideIcon("calendar-plus", __iconNode$v);
const __iconNode$u = [
  ["path", { d: "M8 2v4", key: "1cmpym" }],
  ["path", { d: "M16 2v4", key: "4m81vk" }],
  ["rect", { width: "18", height: "18", x: "3", y: "4", rx: "2", key: "1hopcy" }],
...
const HeartHandshake = createLucideIcon("heart-handshake", __iconNode$p);
const __iconNode$o = [
  [
    "path",
    {
...
const Linkedin = createLucideIcon("linkedin", __iconNode$l);
...
const Newspaper = createLucideIcon("newspaper", __iconNode$d);
const __iconNode$c = [
  [
    "path",
    {
